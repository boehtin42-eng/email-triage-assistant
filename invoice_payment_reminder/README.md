...
- Upload a PDF, TXT, PNG, or JPG expense invoice and extract likely expense fields
...
Free OCR support uses Tesseract. Text-readable PDFs are usually more accurate than scan/photo invoices.
